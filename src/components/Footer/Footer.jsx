        ...
        <Box sx={{py: 10,backgroundColor:'#FFF6B2'} }>
            <CustomContainer>
                ...
                <Box>
                    ...
                    <IconBox>
                        <img src={fbIcon} alt='fbIcon' styled={{cursor:'pointer'}}/>
                        <img src={twitterIcon} alt='twitterIcon' styled={{cursor:'pointer'}}/>
                        <img src={linkedinIcon} alt='linkedIcon' styled={{cursor:'pointer'}}/>
                    </IconBox>
